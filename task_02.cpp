...
//  2.Игра «Составь предложение».Есть файлы : Кто, Где, Когда, С кем, Что делали, 
//  Что получилось, Мораль.Пользуясь Math.random(), программа составляет шуточное 
//  предложение и показывает его на экран.
